...
import { ArrowRight, Brain, Database, Users, Cpu, Shield, Target, Sparkles, Timer, Home } from "lucide-react";
              ...
              <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 max-w-5xl mx-auto">
                {assessmentCategories.map((category, index) => (
                  ...
                  >
                    ...
                    <TooltipContent>
                      <p>Click to start assessment focusing on {category.title.toLowerCase()}</p>
                    </TooltipContent>
                  </Tooltip>
                ))}
              </div>
